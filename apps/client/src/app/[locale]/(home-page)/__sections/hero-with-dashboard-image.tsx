                    ...
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4">
                            <div
                                ...
                                data-wow-delay=".2s"
                            >
                                <h1 className="mb-6 text-3xl font-bold leading-snug  sm:text-4xl sm:leading-snug lg:text-7xl lg:leading-[1.2] gradient-text">
                                    Revolutionary <br />
                                    LMS Platform
                                </h1>
                                <p className="mx-auto mb-9 max-w-[600px] text-base font-medium  sm:text-lg sm:leading-[1.44]">
                                    Experience the next generation of learning management with AI-powered insights, immersive content delivery, and seamless multi-tenant architecture.
                                </p>
                                <ul className="mb-10 flex flex-wrap items-center justify-center gap-5">
                                    <li>
                                        <Link
                                            href="https://nextjstemplates.com/templates/play"
                                            className="inline-flex items-center justify-center rounded-md  px-7 py-[14px] text-center text-base font-medium text-dark shadow-1 transition duration-300 ease-in-out hover:bg-gray-2"
                                        >
                                ...
                                <div>
                                    <p className="mb-4 text-center text-base font-medium /60">
                                    ...
                                    >
                                        <Link
                                            ...
                                            className="/60 duration-300 ease-in-out hover:"
                                            target="_blank"
                                        >
                                            <svg
                                                className="fill-current"
