                    ...
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4">
                            ...
                            >
                                ...
                                <h1
                                    className=" text-3xl font-bold leading-snug  sm:text-4xl sm:leading-snug lg:text-8xl lg:leading-[1.2] gradient-text my-12"
                                >
                                    {t("title")}
                                </h1>
                                ...
                                <div>
                                    ...
                                    >
                                        <div className="flex flex-col items-center gap-2 group">
                                            ...
                                            <span className="text-sm font-medium">{t("cloudBased")}</span>
                                        </div>
                                        <div className="flex flex-col items-center gap-2 group">
                                            <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
                                                <Smartphone className="w-6 h-6 text-primary" />
                                            </div>
                                            <span className="text-sm font-medium">{t("mobileReady")}</span>
                                        </div>
                                        <div className="flex flex-col items-center gap-2 group">
                                            <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
                                        ...
                                        <div className="flex flex-col items-center gap-2 group">
                                            ...
                                            <span className="text-sm font-medium">{t("multiTenant")}</span>
                                        </div>
                                        <div className="flex flex-col items-center gap-2 group">
                                            <div className="p-3 rounded-lg bg-primary/10 group-hover:bg-primary/20 transition-colors">
