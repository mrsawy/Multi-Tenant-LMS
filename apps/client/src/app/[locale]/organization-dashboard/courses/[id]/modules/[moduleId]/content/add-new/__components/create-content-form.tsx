...
import { createContent } from "@/lib/actions/courses/content.action";
...
export default function CreateContentForm({ courseId, moduleId }: CreateContentFormProps) {
  const [contentType, setContentType] = useState<CourseContentType>(CourseContentType.ARTICLE);
  ...
  const onSubmit = async (values: CourseContentFormData) => {
    ...
    try {
      ...
      await createContent(moduleId, courseId, contentData, fileKey);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-4">
              <Link
                href={`/organization-dashboard/courses/${courseId}/modules/${moduleId}`}
            ...
            <Tabs defaultValue="content" className="w-full">
              ...
              <TabsContent value="content" className="space-y-6">
                ...
                {contentType === CourseContentType.VIDEO && (
                  <VideoContentForm register={register} errors={errors} setValue={setValue} />
                )}
