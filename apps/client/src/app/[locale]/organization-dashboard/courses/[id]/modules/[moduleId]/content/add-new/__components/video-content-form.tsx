...
export default function VideoContentForm({ register, errors, setValue }: VideoContentFormProps) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-6">
        <Tabs defaultValue={VideoType.URL} className="w-full">
          <TabsList className="grid w-full grid-cols-2">
            <TabsTrigger value={VideoType.URL} className="flex items-center space-x-2" onClick={() => { setValue("content.videoType", VideoType.URL) }}>
