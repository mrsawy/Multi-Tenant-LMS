...
import { createCourseModule } from "@/lib/actions/courses/modules.action";
...
function CreateModuleForm({ courseId, setOpen }: { courseId: string, setOpen: React.Dispatch<React.SetStateAction<boolean>> }) {
    ...
    async function onCreateModule(values: any) {
        try {
            ...
            await createCourseModule({ courseId, ...moduleData });
            reset();
            setLearningObjectives([""]);
            setOpen(false);
            toast.success("Module Created")
        } catch (error: any) {
            toast.error(error.message ? error.message : "Something went wrong , Please try again later")
        } finally {
