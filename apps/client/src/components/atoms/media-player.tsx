...
interface MediaPlayerSeekBackwardProps extends ButtonProps {
  seconds?: number;
}
...
interface MediaPlayerSeekForwardProps extends ButtonProps {
  seconds?: number;
}
...
interface MediaPlayerPlaybackSpeedProps
  ...
  ButtonProps,
  Omit<React.ComponentPropsWithoutRef<typeof DropdownMenu>, "dir">,
  Pick<React.ComponentPropsWithoutRef<typeof DropdownMenuContent>, "sideOffset"> {
  speeds?: number[];
}
...
interface MediaPlayerLoopProps extends ButtonProps { }
...
interface MediaPlayerFullscreenProps extends ButtonProps { }
