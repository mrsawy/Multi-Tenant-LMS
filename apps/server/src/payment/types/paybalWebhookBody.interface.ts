...
export interface PayPalSubscriptionCreatedWebhookBody
  extends PayPalWebhookBody<
    PayPalSubscriptionResource,
    'BILLING.SUBSCRIPTION.ACTIVATED'
  > {}
export interface PayPalSaleWebhookBody
  extends PayPalWebhookBody<PayPalSaleResource, 'PAYMENT.SALE.COMPLETED'> {}

export type PayPalWebhookBodyType =
  | PayPalSubscriptionCreatedWebhookBody
  | PayPalSaleWebhookBody;
